...
from PyQt5.QtCore import QEvent, Qt, pyqtProperty
...
class TitleBar(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.__backgroundColor = QColor("#212121")
    ...
    def setFixedHeight(self, h: int) -> None:
        self.minBtn.setFixedSize(h, h)
        self.closeBtn.setFixedSize(h, h)
        self.maxBtn.setFixedSize(h, h)
...
class StandardTitleBar(TitleBar):
    ...
    def __init__(self, parent):
        # super().__init__会调用setFixedHeight
        # setFixedHeight中会引用iconLabel
        # 因此先用None声明
        self.iconLabel = None  
    ...
    def setIcon(self, icon):
        ...
        """
        self.iconLabel.setPixmap(QIcon(icon).pixmap(self.height(), self.height()))
